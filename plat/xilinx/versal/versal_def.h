...
#ifndef __VERSAL_DEF_H__
#define __VERSAL_DEF_H__
...
#define PLAT_ARM_CRASH_UART_BASE	VERSAL_UART_BASE
#define PLAT_ARM_CRASH_UART_CLK_IN_HZ	VERSAL_UART_CLOCK
#define ARM_CONSOLE_BAUDRATE		VERSAL_UART_BAUDRATE
